...
import 'package:daraz_style_product_listing/services/api/api.dart';
...
class ApiServices {
  ...
  Future<dynamic> postServices({required String url, dynamic body, int statusCodeStart = 200, int statusCodeEnd = 299, Map<String, dynamic>? query}) async {
    try {
