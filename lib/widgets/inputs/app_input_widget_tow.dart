        ...
        children: [
            ...
            SizedBox(
              ...
              child: SingleChildScrollView(
                ...
                child: Row(
                  ...
                  children: [
                    AppText(text: widget.title ?? "", fontWeight: FontWeight.w500, color: widget.titleColor ?? AppColors.instance.black900, fontSize: widget.titleFontSize ?? 18),
                    Padding(
                      padding: EdgeInsets.only(right: AppSize.width(value: 10.0)),
                      child: AppText(text: widget.subTitle ?? "", fontWeight: widget.fontWeight ?? FontWeight.w400, color: widget.titleColor ?? AppColors.instance.black900, fontSize: 14),
                    ),
                  ],
                ),
              ),
          ...
          ClipRRect(
            ...
            child: TextFormField(
              ...
              style: widget.style ?? Theme.of(context).textTheme.titleSmall?.copyWith(color: widget.textColor ?? AppColors.instance.black300, fontWeight: FontWeight.w400, fontSize: 16),
              ...
              decoration: InputDecoration(
                ...
                errorStyle: TextStyle(color: widget.errorColor ?? AppColors.instance.error, fontWeight: FontWeight.w500, fontFamily: AppConstant.instance.font, fontSize: 12),
                border:
                    widget.border ??
                    OutlineInputBorder(
                      borderRadius: BorderRadius.circular(AppSize.width(value: 8.0)),
