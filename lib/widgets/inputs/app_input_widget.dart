...
class _AppInputWidgetState extends State<AppInputWidget> {
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      obscuringCharacter: "*",
      style: widget.style ?? TextStyle(height: 2, color: widget.textColor, fontFamily: AppConstant.instance.font, fontWeight: FontWeight.w500),
      ...
      decoration: InputDecoration(
        ...
        prefixIconConstraints: widget.prefixIconConstraints ?? BoxConstraints(maxHeight: AppSize.width(value: 20), maxWidth: AppSize.width(value: 35)),
        ...
        labelStyle: widget.hintStyle ?? Theme.of(context).textTheme.titleSmall?.copyWith(color: widget.textColor ?? AppColors.instance.black300, fontFamily: AppConstant.instance.font),
