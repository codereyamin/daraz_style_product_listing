...
import 'package:daraz_style_product_listing/widgets/texts/app_text.dart' show AppText;
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        child: isLoading
            ...
            : child ?? AppText(text: title ?? "", color: titleColor ?? AppColors.instance.white50, fontWeight: fontWeight ?? FontWeight.w700, fontSize: fontSize ?? 20),
      ),
    );
  }
}
