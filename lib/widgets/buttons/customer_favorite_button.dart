...
import 'package:daraz_style_product_listing/constant/app_asserts_icons_path.dart';
...
class _CustomerFavoriteButtonState extends State<CustomerFavoriteButton> {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: ImageIcon(AssetImage(isSelected ? AppAssertsIconsPath.instance.loveFill : AppAssertsIconsPath.instance.love), color: AppColors.instance.orange500),
    );
  }
}
