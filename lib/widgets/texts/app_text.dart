...
import 'package:daraz_style_product_listing/utils/languages/language_provider.dart';
import 'package:daraz_style_product_listing/utils/languages/translation_cache.dart';
    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          return Text("...", maxLines: widget.maxLines, overflow: widget.overflow, textAlign: widget.textAlign, style: style, textScaler: TextScaler.linear(widget.textScaleFactor));
        }
