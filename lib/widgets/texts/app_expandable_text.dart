...
class AppExpandableText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ReadMoreText(
      ...
      lessStyle: TextStyle(fontSize: 14, fontFamily: fontFamily ?? AppConstant.instance.font, fontWeight: FontWeight.bold, color: collopsTextColor ?? AppColors.instance.primary),
      moreStyle: TextStyle(fontSize: 14, fontFamily: fontFamily ?? AppConstant.instance.font, fontWeight: FontWeight.bold, color: expandedTextColor ?? AppColors.instance.primary),
    );
  }
}
